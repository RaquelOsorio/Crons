# Django settings for gestograma project.
#encoding:utf-8
...
MANAGERS = ADMINS
AUTH_PROFILE_MODULE = 'reglas.Usuario'
...
#'NAME': '/ruta_del_directorio_del_proyecto/gestograma/gestograma.db',
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'reglas.db',          # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'Crons.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Crons.wsgi.application'
